...
//write a function that renders name
...
//write a function to create an array of each inventory
...
//if inventory[0]['shoes'][0]['name'] === black return it do the function from the previous exercise